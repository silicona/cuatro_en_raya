<?php  //[STAMP] 91f521effd0c9aadef14438463d5c564
...
trait UnitTesterActions
{
     ...
     *
     *
     * @see \Helper\Unit::seeMyVar()
     */
    public function seeMyVar($var) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeMyVar', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Unit::seeMyVar()
     */
    public function canSeeMyVar($var) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeMyVar', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Unit::callMethod()
     */
    public function callMethod(object $obj, string $functionName, array $args) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('callMethod', func_get_args()));
    }
}
