<?php  //[STAMP] c78efd75e90ab5b59ce809f1c68088e8
...
trait BbddTesterActions
{
     ...
     *
     *
     * @see \Helper\Bbdd::selectAll()
     */
    public function selectAll(string $table, array $criteria = [], string $column = "*") {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('selectAll', func_get_args()));
    }
}
