<?php  //[STAMP] c63559e0d6359396f66111738e510756
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::assertJar()
     */
    public function assertJar($expected, $actual, $message = "") {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertJar', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::printVar()
     */
    public function printVar($var) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('printVar', func_get_args()));
    }
}
